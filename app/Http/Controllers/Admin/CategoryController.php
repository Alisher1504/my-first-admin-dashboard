...
class CategoryController extends Controller
{
    ...
    public function update(CategoryFormRequest $request, $category_id) {
        ...
        if($request->hasfile('image')) {
            ...
            $destinarion = 'uploads/category/' . $category->image;
            if(File::exists($destinarion)){
                File::delete($destinarion);
            }
     ...
     public function destroy(Request $request) {
        ...
        if($category) {
            ...
            $category->delete();
            return redirect('admin/category')->with('message', 'Category deletedwith its posts Successfully');
        }
        else {
